...
public class FFT {
    ...
    public static double[] makeWindow(int choice, int size, int support) {
        ...
        switch (choice) {
        case RECT:
            rectangle(data, support);
            break;
        case HAMMING:
            hamming(data, support);
            break;
        case BH3:
            blackmanHarris3s(data, support);
            break;
        case BH4:
            blackmanHarris4s(data, support);
            break;
        case BH3MIN:
            blackmanHarris3sMin(data, support);
            break;
        case BH4MIN:
            blackmanHarris4sMin(data, support);
            break;
        case GAUSS:
            gauss(data, support);
            break;
